...
- `test/concurrent_returns_test.dart`: the D-029 conflict cases worked by hand (PLAN A1-6, A1-7), plus the QA-024 over-refund case, skipped until the contract closes it.
